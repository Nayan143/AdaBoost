...
def adaboostLSLC(X, Y, K, nSamples):
    ...
    #Use a more complex weak classifier in the AdaBoost framework, namely the least squares classifier. Implementation of the AdaBoost algorithm in using least 		squares classifier
    N, D = X.shape
    alphaK = np.zeros(K)
